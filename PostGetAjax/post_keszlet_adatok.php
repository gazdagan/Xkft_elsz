    ...
    $sql = "SELECT * FROM telephelyek";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $sql1 = "SELECT * FROM aru_keszlet WHERE keszlet_raktar = '$raktar'  AND keszlet_aru_id = '$keszlet_aru_id' AND keszlet_torolt = '0' ORDER BY keszlet_id DESC LIMIT 1";
                        $result1 = $conn->query($sql1);
