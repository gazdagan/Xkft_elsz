...
if (isset($_GET["kezelo_neve"])){
        ...
        $sql ="SELECT DISTINCT * FROM `kezeles_arak_jutalek` INNER JOIN szolgaltatasok ON szolg_neve = kezeles_arak_jutalek.kezeles_tipus WHERE kezeles_arak_jutalek.kezelo_neve = '$kezelo_neve' ORDER BY kezeles_arak_jutalek.kezeles_tipus ASC ";
