        ...
        echo '<table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Kezelő Cégnév</th>
                        <th>Kezelő Cég cím</th>
                        <th>Kezelő Cég adószám</th>
                        <th>Hozzáad</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <td> <input type = "text" class = "form-control" name = "kezelo_cegnev"></td>
                    <td> <input type = "text" class = "form-control" name = "kezelo_cegcim"></td>
                    <td> <input type = "text" class = "form-control" name = "kezelo_cegadosz"></td>
...
// output echo "
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                . $row["kezelo_ceg_nev"] . "</td><td>"
                . $row["kezelo_ceg_cim"] . "</td><td>"
                . $row["kezelo_ceg_adosz"] . "</td><td>"
    ...
    public function admin_post_insert_kezelo() {
        if (isset($_POST["kezelo_neve"]) ) {
            ...
            $kezelo_ceg_nev = test_input($_POST["kezelo_cegnev"]);
            $kezelo_ceg_cim = test_input($_POST["kezelo_cegcim"]);
            $kezelo_ceg_adosz = test_input($_POST["kezelo_cegadosz"]);     
           
            $sql = "INSERT INTO kezelok_orvosok (kezelo_neve, kezelo_tipus,kezelo_megj,kezelo_telephely,kezelo_ceg_nev,kezelo_ceg_cim,kezelo_ceg_adosz)
            VALUES ('$kezelo_neve','$kezelo_tipus','$kezelo_megj','$kezelo_telephely','$kezelo_ceg_nev','$kezelo_ceg_cim','$kezelo_ceg_adosz')";
    ...
    public function select_kezelo_Cegnev($kezelo,$rendelo){
        
        $return = "";

        $sql = "SELECT * FROM kezelok_orvosok WHERE kezelo_neve = '$kezelo' AND kezelo_telephely = '$rendelo'";
    ...
    public function select_kezelo_Cegcim($kezelo,$rendelo){
     ...
     public function select_kezelo_CegAdosz($kezelo,$rendelo){
