...
class visualize_menu {
    ...
    public function __construct() {
        ...
        $cegadat = new telephely_db();
        $this->cegnev = $cegadat->select_CegNeve($this->telephely);
    ...
    function usermenu($usertype) {
        ...
        echo '<nav class="navbar navbar-inverse navbar-fixed-top">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="./index.php?pid=page10" data-toggle="tooltip" data-placement="bottom" title="." id = "select_telehely">'. $this->telephely.'</a>
                    </div>
            ...
            // átadás csak Medical plusz Madarász V 49 teleplyén van
            if ($this->telephely == "MV49" ) {                               
                    echo '<li><a href="./index.php?pid=page17" data-toggle="tooltip" data-placement="bottom" title="Napon belüli átadás elszámolás">Átadás</a></li>';
                        
            }           
                    echo '<li class = "dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Napi összesítő
                             <span class="caret"></span></a>'
                            . '<ul class = "dropdown-menu">'
                            . '<li><a href="./index.php?pid=page28" data-toggle="tooltip" data-placement="" title="Napi végi összesített a kivélasztott rendelőben">1 - Napi összesítő</a></li>'
                            . '<li><a href="./index.php?pid=page281" data-toggle="tooltip" data-placement="" title="Artáéria ellenörzés rögzítésa">2 - Artéria pénzforgalmi ellenörzés</a></li>'
                            . '</ul></li>';
        ...
        if ($usertype == "superadmin") {
            echo '<li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Adatbevitel
                                <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="./index.php?pid=page80">1 - Orvosok Kezelők</a></li>
                                <li><a href="./index.php?pid=page81">2 - Szolgáltatások</a></li>
                                <li><a href="./index.php?pid=page86">3 - Árak Jutalékok</a></li>
                                <li><a href="./index.php?pid=page83">4 - Egészségpénztárak</a></li>
                                <li><a href="./index.php?pid=page84">5 - Telephelyek</a></li>
                                <li><a href="./index.php?pid=page85">6 - Felhasználók</a></li>
                                <li><a href="./index.php?pid=page95" data-toggle="tooltip" data-placement="bottom" title="páciens tetszőleges időpontra történő rögzítése">7 - Pótrögzítés</a></li>
            ...
            echo '<li class="dropdown">
                               <a class="dropdown-toggle" data-toggle="dropdown" href="#">Riportok
                                   <span class="caret"></span></a>
                               <ul class="dropdown-menu">
                                   <li><a href="./index.php?pid=page90" data-toggle="tooltip" data-placement="bottom" title="időszaki forgalom lekérdezése">1 - Időszaki összesítés</a></li>
                                   <li><a href="./index.php?pid=page91" data-toggle="tooltip" data-placement="bottom" title="2018 havi orvos kezelo jutalékok táblázata">2 - Orvos, kezelo havi jutalékok</a></li>
                                   <li><a href="./index.php?pid=page92" data-toggle="tooltip" data-placement="bottom" title="2018 havi orvos, kezelo bevételek összesen táblázatban">3 - Orvos, kezelo havi bevételek</a></li>
                                   <li><a href="./index.php?pid=page93" data-toggle="tooltip" data-placement="bottom" title="Időszaki orvos, kezelo jutaléklista">4 - Jutalékelszámolás könyveléshez</a></li>
                                   <li><a href="./index.php?pid=page94">5 -Rendelők napi forgalma</a></li>
                                   <li><a href="./index.php?pid=page96">6 - telephelyi netto </a></li>
                                   <li><a href="./index.php?pid=page97">7 - orvos kezelo netto</a></li>
                                   <li><a href="./index.php?pid=page98">8 - orvos kezelo allin</a></li>
                                   <li><a href="./index.php?pid=page79">9 - Postázandók számlák</a></li>
                                   <li><a href="./index.php?pid=page78">10 - Átutalásos számlaképek</a></li>
                                   <li><a href="./index.php?pid=page76">11 - Pénztárgép napi elszámolásai</a></li> 
                                   <li><a href="./index.php?pid=page798">12 - Alapvizsg / konroll DR</a></li>';
        ...
        echo'<li><a href ="#">'.$this->cegnev.'</a></li>';
        echo'<li><a href="#">';
...
// morvosok jutalékelszámolás egyedi menüje 
    function jutalkos_menu(){
      ...
      $cegnev = $_SESSION['set_telephely'];
     
              
        $html .=   '<nav class="navbar navbar-default">
                    <div class="container-fluid">
                      <div class="navbar-header">
                        <a class="navbar-brand" href="#">'.$cegnev.' elszámolás</a>
                      </div>';
                            ...
                            $sql = "SELECT * FROM telephelyek";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        $html .= '<option value="'.$row["telephely_neve"].'">'.$row["telephely_neve"].' / '. $row["CegNeve"] . '</option>';
                                    }
                                } else {
                                    echo "0 results";
                                }
       ...
       $html .= '<form class="navbar-form navbar-left" action="' . $_SERVER["PHP_SELF"] . '?pid=page931" method="POST" ><div class="form-group"> '
                    . '<button type = "submit" class = "btn btn-primary" onclick=""><i class="fa fa-calendar-o" aria-hidden="true"></i> Mai napi jutalékelszámolás</button>'
                     .'   <input type="hidden" class="form-control" name="jutalek_day" value="'.date("Y-m-d").'">
                          <input type="hidden" name = "select_terapeuta"  value="'. $_SESSION['real_name'].'" >
                          <input type="hidden" name = "jutaleklista_tipus" value="all_jutalek" >  
                          <input type="hidden" name = "szamla_vevo" value="'.$cegnev.'" >   ' 
               . '</div></form>'; 
    ...
    function include_partials() {
        ...
        switch ($pageid) {
            ...
            case "page28":
                ...
                break;
            case "page281":
                include ("./partials/user/penzforgalmi_ellenorzes.php");
                break;
            case "page29":
