...
public function keszlet_lista(){
    ...
    $html .= '<table class="table table-condensed">
            <thead >
              <tr style="">
                ...
                if ($result->num_rows > 0) {
                    ...
                    $html .=  '<th style="Color:red;">' . $row["telephely_neve"] . '</th>';
     ...
     $html .=   '<th style="Color:red;">Központi készlet</th>
                <th style="text-align:right;">Átlagár Ft</th>
                                   ...
                                   $html .=  '<tr id="keszlet_id_'.$cikk_id.'">
                                                ...
                                                $sql2 = "SELECT * FROM telephelyek";
                                                   ...
                                                   if ($result2->num_rows > 0) {
                                                        ...
                                                        $raktar = $row["telephely_neve"]; 
                                                        $html .=   '<td style="width:150px;">
                                                                        <div class="input-group" data-toggle="tooltip" title="'.$raktar.'" ><div class="input-group-btn">
                                                                        <buttom class="btn btn-default" onclick = ReadonlyChange("aru_keszlet_'.$raktar.'_'.$cikk_id.'")><i class="fa fa-pencil-square-o"></i></buttom></div>
                                                                        <input  type="number" data-placement="left" data-raktar="'.$raktar.'" data-cikkid="'.$cikk_id.'" class="form-control" id="aru_keszlet_'.$raktar.'_'.$cikk_id.'" value="'.$this->cikkdb_raktar_from_cikk_id_lastone($cikk_id,$raktar).'" onchange="update_keszlet(this.id)" min="0" disabled>
                                                                        </div>    
                                                                   </td>';
    ...
    $html .= '<table class="table table-condensed">
            <thead>
              <tr>
                ...
                <th style="Color:red;">Beszerzés 1db Ár FT</th>
            ...
            <thead>
              <tr>
                ...
                if ($result->num_rows > 0) {
                    ...
                    $html .=  '<th style="Color:red; text-align:center;">' . $row["telephely_neve"] . '</th>';
                    
                    }
                } else {
                    echo "0 results";
                }
       $html .='<th style="Color:red; text-align:center;">Központi készlet</th>
                <th style="text-align:right;">Átlagár Ft</th>
                <th style="text-align:right;">Készlet db</th>
                <th style="text-align:right;">Készlet érték Ft</th>
                                                ...
                                                <td>'.$row["aru_meret"].'</td>';
                                                   ...
                                                   if ($result2->num_rows > 0) {
                                                        ...
                                                        $html .=    '<td style="width:150px; text-align:center;">
                                                                        '.$this->cikkdb_raktar_from_cikk_id_date($cikk_id,$raktar,$keszlet_datum).'
                                                                    </td>';
                    ...
                    <select class="form-control" id="keszlet_szallito" name="keszlet_szallito">';
                        ...
                        $result = $this->dbconn->query($sql);
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                $raktar = $row["telephely_neve"];        
                                $html .=  '<option value="'.$raktar.'">'.$raktar.'</option>';
                                }
                            } else {
                                echo "0 results";
                            }
                    
         $html .=   '<option value="Kozponti_keszlet">Központi készlet</option>
                    </select>
                  </div>
