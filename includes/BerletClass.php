...
class BerletClass extends napi_elszamolas {
     ...
     */
    function Create_Berlet($paciens,$gyogytornasz,$berlet_alkalom,$szolgaltatas,$telephely,$berlet_lejarat,$bevosszeg,$szamlaszam) {

        $conn = DbConnect();

        $sql = "INSERT INTO berlet_kezeles (berlet_vevo, berlet_gyogytornasz, berlet_tipus, berlet_alkalom, berlet_neve, berlet_telephely, berlet_lejar, berlet_ar, szamlaszam) "
                . "VALUES ('$paciens','$gyogytornasz','$berlet_alkalom','0','$szolgaltatas','$telephely','$berlet_lejarat','$bevosszeg', '$szamlaszam')";
 ...
 */    
        ...
        if (isset($_POST["berlet_alkalom_id"])) {
            ...
            if ($alkalomszam < $berlettipus) 
                ...
                $alkalomszam++;
                    ...
                    $date = date("Y-m-d");
                    $berlet_alk_ar = $berlet_ar / $berlettipus;
                    $sql = "INSERT INTO napi_elszamolas (paciens_neve , kezelo_orvos_id, szolgaltatas_id
                            ,bevetel_tipusa_id,ep_tipus, bevetel_osszeg,jutalek_osszeg, szamlaszam, berlet_adatok, rogzito, telephely, date,el_beteglista_id,berlet_alk_ar)
                            VALUES ('$pname','$kezelo_orvos','$berlet_neve No.: $berlet_id','','','','','','$berlettipus/$alkalomszam','$this->rogzito','$this->telephely','$date','$this->beteglista_id','$berlet_alk_ar')";
    ...
    public function User_Post_Search_Berlet(){
            ...
            if (isset($_POST["berlet_id_search"])){
                ...
                $sql = "SELECT * FROM berlet_kezeles WHERE berlet_id = '$berlet_id'  AND berlet_torolt = 0 AND berlet_alkalom < berlet_tipus AND (berlet_lejar >= '$this->datetoday' OR berlet_lejar = '0000-00-00') ";
            ...
            if (isset($_POST["pname_search"])){
                ...
                $sql = "SELECT * FROM berlet_kezeles WHERE berlet_vevo LIKE '%$berlet_vevo%'  AND berlet_torolt = 0 AND berlet_alkalom < berlet_tipus AND (berlet_lejar >= '$this->datetoday' OR berlet_lejar = '0000-00-00') ORDER BY berlet_vevo";
                $this->searchresult = $conn->query($sql);
                return TRUE;
            }
            ...
            if (isset($_POST["BMM_cardSN_search"])){
                ...
                $sql = "SELECT * FROM berlet_kezeles WHERE user_id = '$BMM_kartyaszam' AND berlet_alkalom < berlet_tipus AND (berlet_lejar >= '$this->datetoday' OR berlet_lejar = '0000-00-00') ORDER BY berlet_vevo";        
                $this->searchresult = $conn->query($sql);
                return TRUE;
            }
...
public function BerletListak(){
 ...
 $html .= '<ul class="nav nav-tabs">
    <li><a data-toggle="tab" href="#menu1">1 alk</a></li>
    <li class="active"><a data-toggle="tab" href="#menu5">5 alk</a></li>
    <li><a data-toggle="tab" href="#menu10">10 alk</a></li>
    <li><a data-toggle="tab" href="#menu3">Gyakorló 3 alk</a></li>
    <li><a data-toggle="tab" href="#menu8">Gondoskodó 8 alk</a></li>
    <li><a data-toggle="tab" href="#menu20">Tudatos 20 alk</a></li>
    <li><a data-toggle="tab" href="#menu30">Elhivatott 30 alk</a></li>
  </ul>

  <div class="tab-content">
    <div id="menu1" class="tab-pane fade">
      '.$this->Visualize_All_Berlet_FromBD(1).'
    </div>
